...
Задания идут в порядке, который прислал сервер: знакомства, вспоминания вразбивку, 2–3 знакомых слова из других папок, коллокация-якорь. Рендер — `exercise.design.md`. Особенности раунда:
