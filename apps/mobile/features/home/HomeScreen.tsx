...
/**
 * СКРЫТ с 2026-09-23: пока загрузка нужна только ради слов, Главной нет в
 * табах, а `/` ведёт на «Загрузку» (`app/(tabs)/index.tsx`). Чтобы вернуть —
 * отрисовать этот компонент из `app/(tabs)/index.tsx` и вернуть вкладку в
 * `TAB_ITEMS` в `app/(tabs)/_layout.tsx`.
 *
